...
def Daisy_Feature_Extractor_Fn(vid,num_frames,frame_no,N,new_shape=(360,480),step=60, radius=40):
    N=4
	        ...
	        if current_file.endswith('.mp4'):
                 ...
                 try:
                     ...
                     for j in xrange(0,min(5*subsampling_rate*bovw_size*8,num_frames),subsampling_rate):
                         ...
                         current_grid_feature,current_frame_feature=Resnet_Feature_Extractor_Fn(vid,num_frames,j,N) 
